...
LTE_config.channel_model.trace_length = 0.1; % Length of the trace in seconds. Be wary of the size you choose, as it will be loaded in RAM.
...
%% Scheduler options
LTE_config.scheduler        = 'best cqi';  % 'round robin' or 'best cqi'
