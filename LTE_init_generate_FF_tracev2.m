function pregen_H_trace = LTE_init_generate_FF_tracev2(system_bandwidth,channel_type,nTX,nRX,trace_length_s,UE_speed)
...
fading_config_params.f                               = 2110e6;  % Frequency at which our system operates
...
for loop_idx = 1:number_of_loops
    ...
    pregen_H_trace.H_RB_samples(:,:,samples,:) = fading_generation(loop_idx,fading_config_params,rosa_zheng_params,false);
end
...
function H_fft_to_return = fading_generation(loop_idx,fading_config_params,rosa_zheng_params,plot_graphs)
