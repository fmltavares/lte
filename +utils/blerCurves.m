...
% (c) Josep Colom Ikuno, INTHFT, 2008
   ...
   methods
       % Class constructor. As input receives two [NxM] cell arrays containing
       % the BLER curves for N CQI values (1-N) and using M maximum HARQ
       % retransmissions.
       ...
       % multiple CQIs. Input values (SINRs) in LINEAR.
